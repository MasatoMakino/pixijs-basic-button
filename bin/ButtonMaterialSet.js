    ...
    static getMaterial(set, state) {
        ...
        switch (state) {
            case BasicButtonState.DISABLE:
                return _a = set.disable, (_a !== null && _a !== void 0 ? _a : set.normal);
            ...
            case BasicButtonState.SELECT:
                return _d = set.selectNormal, (_d !== null && _d !== void 0 ? _d : set.normal);
            case BasicButtonState.SELECT_OVER:
                return _e = set.selectOver, (_e !== null && _e !== void 0 ? _e : set.normal);
            case BasicButtonState.SELECT_DOWN:
                return _f = set.selectDown, (_f !== null && _f !== void 0 ? _f : set.normal);
            default:
                return set.normal;
        }
    }
