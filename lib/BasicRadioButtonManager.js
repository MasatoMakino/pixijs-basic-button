...
var BasicRadioButtonManager = /** @class */ (function(_super) {
   ...
   */
  BasicRadioButtonManager.prototype.deselectOthers = function(
    selectedButton,
    isDispatchSelectEvent
  ) {
    ...
    if (isDispatchSelectEvent) {
      var evt = new BasicButtonContext_1.BasicButtonContext(
        this._selected,
  ...
  Object.defineProperty(
    BasicRadioButtonManager.prototype,
    "selectedButtonValue",
    {
      /**
